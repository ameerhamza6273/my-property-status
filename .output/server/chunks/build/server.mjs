import { shallowReactive, reactive, effectScope, getCurrentScope, hasInjectionContext, getCurrentInstance, toRef, inject, shallowRef, isReadonly, isRef, isShallow, isReactive, toRaw, computed, defineComponent, useAttrs, ref, mergeProps, unref, h, resolveComponent, watch, withCtx, createVNode, createBlock, createCommentVNode, toDisplayString, openBlock, useSSRContext, provide, Suspense, Fragment, defineAsyncComponent, onErrorCaptured, onServerPrefetch, resolveDynamicComponent, createApp } from 'vue';
import { k as createHooks, l as getContext, i as createError$1, m as toRouteMatcher, n as createRouter, o as defu, q as hasProtocol, r as joinURL, w as withQuery, v as sanitizeStatusCode, x as isScriptProtocol, y as executeAsync, z as withLeadingSlash, A as parseURL, B as encodePath, C as encodeParam, D as parseQuery, E as withTrailingSlash, F as withoutTrailingSlash } from '../_/nitro.mjs';
import { START_LOCATION, createMemoryHistory, createRouter as createRouter$1, RouterView } from 'vue-router';
import VueDatePicker from '@vuepic/vue-datepicker';
import { ssrRenderAttrs, ssrRenderSlot, ssrRenderComponent, ssrRenderList, ssrRenderClass, ssrInterpolate, ssrRenderSuspense, ssrRenderVNode } from 'vue/server-renderer';
...
const _routes = [
  ...
  },
  {
    name: "reports",
    path: "/reports",
    component: () => import('./reports.vue.mjs')
  },
  {
    name: "support",
    path: "/support",
    component: () => import('./support.vue.mjs')
  },
  {
    name: "agencies",
    path: "/agencies",
    component: () => import('./agencies.vue.mjs')
  },
  {
    name: "customers",
    path: "/customers",
  ...
  },
  {
    name: "admin-users",
    path: "/admin-users",
    component: () => import('./admin-users.vue.mjs')
  },
  {
    name: "terms-conditions",
    path: "/terms-conditions",
    component: () => import('./terms-conditions.vue.mjs')
  },
  {
    name: "send-push-notification",
    path: "/send-push-notification",
    component: () => import('./send-push-notification.vue.mjs')
  },
  {
    name: "new-connection-requests",
    path: "/new-connection-requests",
    component: () => import('./new-connection-requests.vue.mjs')
  }
];
...
const vueDatePicker_ah3hqYU1vfXuTCXb4yEkqbGfuXwMgoCH2kALWuDorDg = defineNuxtPlugin((nuxtApp) => {
...
const _sfc_main$2 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _component_DashboardSidebar = _sfc_main$3;
...
export { __nuxt_component_0 as _, _sfc_main$4 as a, server as s, useHead as u };
