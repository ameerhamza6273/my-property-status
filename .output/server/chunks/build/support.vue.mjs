...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "flex h-screen bg-gray-50" }, _attrs))}><h1 class="p-5 text-2xl font-semibold">Support</h1></div>`);
}
...
//# sourceMappingURL=support.vue.mjs.map
