            ...
            <div class="bg-white rounded-xl p-5">
                ...
                <div class="grid grid-cols-1 md:grid-cols-4 gap-4 ">
                    ...
                    <div>
                        ...
                        <Tailwinddropdown v-model="filters.country" button-class="py-2 px-3 bg-[#F8F8F8]" placeholder="Select Country"
                    ...
                    <div>
                        ...
                        <Tailwinddropdown v-model="filters.gender" button-class="py-2 px-3 bg-[#F8F8F8]" placeholder="Select Gender"
